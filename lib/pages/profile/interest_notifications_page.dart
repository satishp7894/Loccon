...
class InterestNotificationsPage extends StatefulWidget {
  @override
  _InterestNotificationsPageState createState() => _InterestNotificationsPageState();
}

class _InterestNotificationsPageState extends State<InterestNotificationsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(centerTitle: true, elevation: 2,
        title: Text('Interest Notifications'),),
      body: SafeArea(
        child: Column(
          children: [
            Expanded(
            ...
            Padding(
              ...
              child: SizedBox(width: double.infinity,
                child: CupertinoButton(color: AppTheme.accentColor,
                    child: Text('Update Interest Notifications'),
                    onPressed: () {
