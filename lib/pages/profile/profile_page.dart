  ...
  Widget build(BuildContext context) {
    ...
    Center(
      child: Column(mainAxisAlignment: MainAxisAlignment.center,
        children: <Widget>[
          Text('Please Login to view Profile.', style: TextStyle(fontSize: 16,
      ...
      child: Scaffold(
        appBar: AppBar(
          title:  Row(
            children: [
              Image.asset("assets/profile_icon.png",height: 15,width: 15,color: AppTheme.accentColor,),
              SizedBox(width: 5,),
              Text('$userName', style: TextStyle(color: AppTheme.accentColor,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          /*GestureDetector(
            child: ClipRRect(
              ...
              child: _imageFile == null ?
                FadeInImage.assetNetwork(placeholder: 'assets/avatar.png',
                  height: 100, width: 100, fit: BoxFit.cover,
                  image: Connection.profilePicPath + '${widget.propic}') :
          ...
          SizedBox(height: 15,),
          Text('$name', style: TextStyle(color: AppTheme.accentColor,
  ...
  Widget _moreView() {
    return  ListView(shrinkWrap: true,
      ...
      children: <Widget>[
        SizedBox(
          ...
          child: UserAccountsDrawerHeader(
            accountName: Text('$userName', style: TextStyle(color: AppTheme.accentColor,
                fontSize: 18, fontWeight: FontWeight.w600),
              textAlign: TextAlign.left,),
            accountEmail: Expanded(
              child: Text('$email - $mobile', style: TextStyle(color: Colors.grey,
                  fontSize: 14, fontWeight: FontWeight.w600),
                textAlign: TextAlign.left,),
            ),
      ...
      /*  SizedBox(height: 50,
        ...
        SizedBox(height: 50,
          child: ListTile(
            leading: Icon(Icons.notifications, color: AppTheme.accentColor,),
        ...
        SizedBox(height: 50,
          child: ListTile(
            ...
            title: Text('Share this app', style: TextStyle(fontSize: 18,),),
            trailing: Icon(Icons.chevron_right,
              color: Colors.grey,),
            onTap: () {
              Share.share('Download The Loccon App.https://play.google.com/store/apps/details?id=com.proactii.loccon');
            },
          ),
        ),
        Divider(indent: 15, endIndent: 10,
